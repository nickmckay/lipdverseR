...
updateProject("globalHolocene","~/Dropbox/HoloceneLiPDLibrary/masterDatabase/","~/GitHub/lipdverse/html/",qcId = "1JEm791Nhd4fUuyqece51CSlbR2A2I-pf8B0kFgwynug",googEmail = "nick.mckay2@gmail.com",updateWebpages = TRUE)
